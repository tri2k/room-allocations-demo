...
**Target:** one web app, one API, one Postgres. Staff hostname + `live.berkeley.mt` (public routes omit sensitive fields). Room laptops use a room session. Paper backup if the site dies. Spec: [integrated system](specs/2026-08-24-integrated-system.md).
