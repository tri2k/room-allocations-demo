...
| API | One HTTP API |
| Identity | **Google** → `people.id`. Ops if `can_open_ops`. Live guests: none. Live admin: same staff flag at `/admin`. Room password is Swire’s. [Auth by screen](specs/2026-08-23-bmt-2026-architecture.md#auth-by-screen) |
