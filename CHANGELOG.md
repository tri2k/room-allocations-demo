...
- **Roster:** optional per room. Power, Guts, and middle-school all-day assignments can be listed. Individual room assignment is undecided (coaches check in; 30 / 1300 mismatches last time, 2.3%). A room with no roster must still work.
