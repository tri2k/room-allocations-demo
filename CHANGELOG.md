...
- **Auth:** volunteers OAuth is decided (signup, profile, and that host’s admin). HQ, planner, roomsdb, and live `/admin` are not. A volunteer cookie does not open those hosts.
