...
- **Staff is one flag on that person**, not an organization product. Signup does not grant it. The first officers are an email allowlist. Someone with the flag can grant it. One flag opens HQ, the planner, roomsdb, and the volunteers admin.
