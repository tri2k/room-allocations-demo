...
- **Staff is a flag on the person**, not an organization product. Signup does not grant it. The first officers are an email allowlist. Re-login from the planner to roomsdb is acceptable. Whether the person who may plan may also edit rooms is open. A second switch is the most that split should be.
