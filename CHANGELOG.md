...
- **One event instance** for planner, HQ, volunteers, and live. Roomsdb is not per event. Swire keeps its own setup. Which admin edits the shared event is still open.
