...
**One org, one Postgres, one API, six links.** A modular monolith. Not six backends. Not six deploys. Persistence: [one Postgres](2026-08-23-bmt-2026-architecture.md#persistence-one-postgres-not-six-databases). Links and API: [integrated system](2026-08-24-integrated-system.md#six-links-how-people-enter). Language and UI library are an implementation choice.
